        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        {{-- <li class="side-menu-label1"><a href="javascript:void(0)">Home Management</a></li> --}}
                        <li><a href="{{ route('homes.index') }}" class="slide-item">Home</a></li>
                        <li><a href="{{ route('abouts.index') }}" class="slide-item">About</a></li>
                        <li><a href="{{ route('servicees.index') }}" class="slide-item">Service</a></li>
                        <li><a href="{{ route('portfolios.index') }}" class="slide-item">Portfolio</a></li>
